describe("form tests", () => {
  ...
  it("Test subscribe form", () => {
    ...
    cy.get("@subscribe-input").type("krystian@gmail.io");
    cy.contains(/invalid email: krystian@gmail.io!/i).should("not.exist");
    cy.getDataTest("subscribe-button").click();
    cy.contains(/invalid email: krystian@gmail.io!/i).should("exist");
  });
});
